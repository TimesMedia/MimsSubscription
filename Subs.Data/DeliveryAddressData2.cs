...
namespace Subs.Data
{
    public class DeliveryAddressData2:BaseModel
    {
        ...
        public static int GetCustomerId(int pDeliveryAddressId)
        {
            try
            {
                List<int> lResults = new List<int>();
        ...
        public bool Format()
        {
            try
            {
                gFormattedAddress[0] = Building + " " + FloorNo + " " + Room;
        ...
        public int CustomerId
        {
            get 
            {
                return GetCustomerId(gTable[0].DeliveryAddressId);
            }
        }
        ...
        public string StreetExtension
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged("StreetExtension");
            }
        ...
        public string StreetSuffix
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged("StreetSuffix");
            }
        }
        ...
        public string StreetNo
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged("StreetNo");
            }
        }
        ...
        public string FloorNo
        {
            ...
            set
            {
                ...
                NotifyPropertyChanged(nameof(FloorNo));
            }
        }
            ...
            set
            {
                switch (CountryId)
                {
                   ...
                   case 38: 
                        if (value.Length != 3)
                        {
                            throw new Exception("The Lesotho postcode needs to be at least 3 characters");
                        }
                        break;
                    ...
                    case 70:
                        if (value.Length != 3)
                        {
                            throw new Exception("The Swaziland postcode needs to be at least 3 characters");
                    ...
                    default:
                        if (value.Length < 4)
                        {
                            throw new Exception("The postcode needs to be at least 4 characters");
                        }
                        break;
                }
                ...
                if (CountryId == 12)
                {
                    // Botswana does not have PostCodes
                    gTable[0].PostCode = "0000";
                }
                else
                { 
