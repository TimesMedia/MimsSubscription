    ...
    public partial class PaymentAllocation : Window
    {
        ...
        public PaymentAllocation(int pSubscriptionId)
        {
            ...
            try
            {
                ...
                // Provide the issue descriptions

                foreach (SubscriptionDoc3.SubscriptionIssueRow item in gSubscriptionIssue)
                {
                    item.IssueDescription = ProductDataStatic.GetIssueDescription(item.IssueId);
                }
