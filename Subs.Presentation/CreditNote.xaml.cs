...
namespace Subs.Presentation
{
    public partial class CreditNote : Window
    {
        ...
        public CreditNote(int pInvoiceId)
        {
            InitializeComponent();
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var lCreditNotes = from lValues in lContext.MIMS_LedgerDoc_CreditNoteBatch_Load(gInvoiceId)
                                   select lValues;
                ...
                if (gListing.Count() == 0 )
                {
                    MessageBox.Show("There are no associated Credit notes.");
                    return;
                }
