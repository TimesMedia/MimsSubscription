...
namespace Subs.Presentation
{
    ...
    public partial class Maintenance : Window
    {
        ...
        //public static bool SendEmailInvoiceOld(string FileName, string Destination, int PayerId)
        //{
        ...
        //        myMessage.Subject = "Tax Invoice: " + FileName.Substring(0, FileName.Length - 4);
        ...
        //        {
        //            ExceptionLevel++;
        //            ExceptionData.WriteException(1, ExceptionLevel.ToString() + " " + CurrentException.Message, "Maintenance", "SendEmailInvoice", "Host = " + myClient.Host);
        //            CurrentException = CurrentException.InnerException;
        //        } while (CurrentException != null);
